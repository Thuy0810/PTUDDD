...
public final class ActivityGoalListBinding implements ViewBinding {
  ...
  private ActivityGoalListBinding(@NonNull LinearLayout rootView,
      @NonNull ExtendedFloatingActionButton fabAdd, @NonNull RecyclerView recyclerGoals,
  ...
  public static ActivityGoalListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGoalListBinding((LinearLayout) rootView, fabAdd, recyclerGoals, textEmpty);
    }
