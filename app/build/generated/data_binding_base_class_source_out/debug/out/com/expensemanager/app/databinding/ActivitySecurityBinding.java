...
public final class ActivitySecurityBinding implements ViewBinding {
  ...
  private ActivitySecurityBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialSwitch switchPin) {
  ...
  public static ActivitySecurityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySecurityBinding((LinearLayout) rootView, switchPin);
    }
